            ...
            <div className="card max-w-2xl w-full p-6 md:p-8 animate-bounce-in">
                ...
                <div className="bg-white/5 rounded-lg p-6 mb-6 text-center">
                    ...
                    <p className="text-white/70">
                        Rank: <span
                        className="text-xl font-bold text-yellow-400">{playerRank}</span> of {sortedPlayers.length}
                    </p>
                </div>
                                ...
                                >
                                    ...
                                    <td className="py-3 px-4 font-medium">
                                        <div className="flex items-center">
                                            {p.avatar ? (
                                                <img src={p.avatar || "/placeholder.svg"} alt=""
                                            ...
                                            <div>
                                                ...
                                                {p.playerIndex && p.playerIndex !== "You" && (
                                                    <span
                                                        className="ml-2 text-xs text-white/50 bg-white/10 px-2 py-0.5 rounded-full">
                              {p.playerIndex}
                            </span>
                                                )}
                                                {p.playerIndex === "You" && (
                                                    <span
                                                        className="ml-2 text-xs text-purple-200 bg-purple-500/30 px-2 py-0.5 rounded-full">
                              {p.playerIndex}
                            </span>
                                                )}
                                            </div>
