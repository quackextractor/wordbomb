        ...
        <div className="card p-4 mb-4">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-3">
                ...
                ${isCurrentTurn ? "ring-2 ring-purple-500 bg-purple-500/10" : "hover:bg-white/10"}`}
                  ...
                  <span
                      className="bg-red-500/70 text-white px-3 py-1 rounded-full text-sm font-bold transform rotate-[-15deg]">
                    ELIMINATED
                  </span>
                                </div>
                            )}
                            ...
                            <div className="flex-1 min-w-0 relative">
                                <div className="font-medium truncate">
                                    ...
                                    {isCurrentTurn && !isPlayerDead && (
                                        <span
                                            className="ml-2 inline-block w-2 h-2 bg-purple-500 rounded-full animate-pulse-custom"></span>
                                    )}
                                </div>
